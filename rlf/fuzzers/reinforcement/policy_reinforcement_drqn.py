...
class PolicyReinforcementDRQN(PolicyBase):
    ...
    def __init__(self, execution, contract_manager, account_manager, args):
        ...
        # self.int_agent = DRQN(state_size=110+ACTION_SIZE, action_size=1)
        self.uint_agent = DRQN(state_dim=110+ACTION_SIZE, action_dim=257)
        # self.uint_agent = DRQN(state_size=110+ACTION_SIZE, action_size=1)
    ...
    def _select_int(self, contract, method, size, obs, chosen_int, x_state, hidden, episole):
        ...
        # action, log_prob = self.int_agent.get_action(x_state)
        # value = action
        new_hidden = None
