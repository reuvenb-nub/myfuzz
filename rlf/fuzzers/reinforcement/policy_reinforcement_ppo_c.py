...
class PolicyReinforcementPPOContinuous(PolicyBase):
    ...
    def __init__(self, execution, contract_manager, account_manager, args):
        ...
        self.int_agent = PPO(state_dim=110+ACTION_SIZE, action_dim=1, lr_actor=lr_actor, lr_critic=lr_critic, gamma=gamma, K_epochs=K_epochs, eps_clip=eps_clip, has_continuous_action_space=has_continuous_action_space, action_std_init=action_std)
        self.uint_agent = PPO(state_dim=110+ACTION_SIZE, action_dim=1, lr_actor=lr_actor, lr_critic=lr_critic, gamma=gamma, K_epochs=K_epochs, eps_clip=eps_clip, has_continuous_action_space=has_continuous_action_space, action_std_init=action_std)
